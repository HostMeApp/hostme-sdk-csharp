...
namespace HostMe.Sdk.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserLoginInfo :  IEquatable<UserLoginInfo>
    { 
...
sb.Append("  ProviderKey: ").Append(ProviderKey).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UserLoginInfo);
        }

        /// <summary>
        /// Returns true if UserLoginInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of UserLoginInfo to be compared</param>
        /// <returns>Boolean</returns>
