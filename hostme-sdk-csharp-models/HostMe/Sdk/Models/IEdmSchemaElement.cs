...
namespace HostMe.Sdk.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class IEdmSchemaElement :  IEquatable<IEdmSchemaElement>
    { 
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as IEdmSchemaElement);
        }

        /// <summary>
        /// Returns true if IEdmSchemaElement instances are equal
        /// </summary>
        /// <param name="other">Instance of IEdmSchemaElement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IEdmSchemaElement other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
