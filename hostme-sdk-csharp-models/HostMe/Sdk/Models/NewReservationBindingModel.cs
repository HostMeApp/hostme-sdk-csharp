...
namespace HostMe.Sdk.Models
{
    ...
    { 
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewReservationBindingModel {\n");
...
sb.Append("  Stroller: ").Append(Stroller).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as NewReservationBindingModel);
        }

        /// <summary>
        /// Returns true if NewReservationBindingModel instances are equal
        /// </summary>
        /// <param name="other">Instance of NewReservationBindingModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewReservationBindingModel other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
