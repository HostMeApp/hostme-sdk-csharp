...
sb.Append("  ProviderKey: ").Append(ProviderKey).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UserLoginInfoViewModel);
        }

        /// <summary>
        /// Returns true if UserLoginInfoViewModel instances are equal
        /// </summary>
        /// <param name="other">Instance of UserLoginInfoViewModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserLoginInfoViewModel other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
