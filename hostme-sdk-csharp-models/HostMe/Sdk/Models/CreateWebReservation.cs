...
namespace HostMe.Sdk.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateWebReservation :  IEquatable<CreateWebReservation>
    { 
...
sb.Append("  CustomerProfile: ").Append(CustomerProfile).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CreateWebReservation);
        }

        /// <summary>
        /// Returns true if CreateWebReservation instances are equal
        /// </summary>
        /// <param name="other">Instance of CreateWebReservation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateWebReservation other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
