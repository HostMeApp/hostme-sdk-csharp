...
namespace HostMe.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SpecialPeriod :  IEquatable<SpecialPeriod>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SpecialPeriod" /> class.
        /// </summary>
        ...
        public SpecialPeriod(bool? Repeat = null, DateTimeOffset? Starts = null, DateTimeOffset? Ends = null, List<HourlyInterval> Time = null, bool? Closed = null)
        {
            this.Repeat = Repeat;
            this.Starts = Starts;
            this.Ends = Ends;
        ...
        /// Gets or Sets Starts
        /// </summary>
        [DataMember(Name="starts", EmitDefaultValue=true)]
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SpecialPeriod);
        }

        /// <summary>
        /// Returns true if SpecialPeriod instances are equal
        /// </summary>
        /// <param name="other">Instance of SpecialPeriod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SpecialPeriod other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Starts != null)
                    hash = hash * 59 + this.Starts.GetHashCode();
                if (this.Ends != null)
                    hash = hash * 59 + this.Ends.GetHashCode();
                if (this.Time != null)
