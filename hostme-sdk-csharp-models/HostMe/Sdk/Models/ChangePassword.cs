...
namespace HostMe.Sdk.Model
{
    ...
    public partial class ChangePassword :  IEquatable<ChangePassword>, IValidatableObject
    {
        ...
        public ChangePassword(string OldPassword = null, string NewPassword = null, string ConfirmPassword = null)
        {
            // to ensure "OldPassword" is required (not null)
            if (OldPassword == null)
            {
                throw new InvalidDataException("OldPassword is a required property for ChangePassword and cannot be null");
            }
            else
            {
            ...
            if (NewPassword == null)
            {
                throw new InvalidDataException("NewPassword is a required property for ChangePassword and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ConfirmPassword is a required property for ChangePassword and cannot be null");
            }
            else
            {
