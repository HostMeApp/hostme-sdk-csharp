...
namespace HostMe.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RegisterAtTable :  IEquatable<RegisterAtTable>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RegisterAtTable {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RegisterAtTable);
        }

        /// <summary>
        /// Returns true if RegisterAtTable instances are equal
        /// </summary>
        /// <param name="other">Instance of RegisterAtTable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RegisterAtTable other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
