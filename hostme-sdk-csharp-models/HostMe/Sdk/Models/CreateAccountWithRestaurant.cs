...
namespace HostMe.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateAccountWithRestaurant :  IEquatable<CreateAccountWithRestaurant>
    { 
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateAccountWithRestaurant {\n");
...
sb.Append("  RestaurantPhone: ").Append(RestaurantPhone).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CreateAccountWithRestaurant);
        }

        /// <summary>
        /// Returns true if CreateAccountWithRestaurant instances are equal
        /// </summary>
        /// <param name="other">Instance of CreateAccountWithRestaurant to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateAccountWithRestaurant other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
