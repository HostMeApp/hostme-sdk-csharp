...
sb.Append("  ConfirmPassword: ").Append(ConfirmPassword).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SetPasswordBindingModel);
        }

        /// <summary>
        /// Returns true if SetPasswordBindingModel instances are equal
        /// </summary>
        /// <param name="other">Instance of SetPasswordBindingModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SetPasswordBindingModel other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
