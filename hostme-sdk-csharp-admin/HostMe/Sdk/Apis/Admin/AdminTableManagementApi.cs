...
namespace HostMe.Sdk.Apis.Admin
{
    ...
    /// </summary>
    public interface IAdminTableManagementApi
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class AdminTableManagementApi : IAdminTableManagementApi
    {
        /// <summary>
...
if (floorId != null) localVarPathParams.Add("floorId", Configuration.ApiClient.ParameterToString(floorId)); // path parameter
        ...
        public ApiResponse< List<TableInfo> > GetAllTableCombinationsWithHttpInfo (int? restaurantId)
        {
            ...
            // verify the required parameter 'restaurantId' is set
            if (restaurantId == null)
                throw new ApiException(400, "Missing required parameter 'restaurantId' when calling AdminTableManagementApi->GetAllTableCombinations");
        ...
        public ApiResponse< List<TableInfo> > GetApprovedTableCombinationsWithHttpInfo (int? restaurantId)
        {
            ...
            // verify the required parameter 'restaurantId' is set
            if (restaurantId == null)
                throw new ApiException(400, "Missing required parameter 'restaurantId' when calling AdminTableManagementApi->GetApprovedTableCombinations");
...
if (tableNumber != null) localVarPathParams.Add("tableNumber", Configuration.ApiClient.ParameterToString(tableNumber)); // path parameter
        ...
        public ApiResponse< TableMonitor > SeatPartyAtTableWithHttpInfo (int? restaurantId, string tableNumber, int? partySize)
        {
            ...
            // verify the required parameter 'partySize' is set
            if (partySize == null)
                throw new ApiException(400, "Missing required parameter 'partySize' when calling AdminTableManagementApi->SeatPartyAtTable");
...
if (tableNumber != null) localVarPathParams.Add("tableNumber", Configuration.ApiClient.ParameterToString(tableNumber)); // path parameter
        ...
        public ApiResponse<Object> SetApprovedTableCombinationsWithHttpInfo (int? restaurantId, List<Table> combinations)
        {
            ...
            // verify the required parameter 'restaurantId' is set
            if (restaurantId == null)
                throw new ApiException(400, "Missing required parameter 'restaurantId' when calling AdminTableManagementApi->SetApprovedTableCombinations");
            
            // verify the required parameter 'combinations' is set
            if (combinations == null)
                throw new ApiException(400, "Missing required parameter 'combinations' when calling AdminTableManagementApi->SetApprovedTableCombinations");
        ...
        public ApiResponse<Object> SetTableStateWithHttpInfo (int? restaurantId, string tableNumber, ChangeTableState stateContract)
        {
            ...
            if (restaurantId != null) localVarPathParams.Add("restaurantId", Configuration.ApiClient.ParameterToString(restaurantId)); // path parameter
if (tableNumber != null) localVarPathParams.Add("tableNumber", Configuration.ApiClient.ParameterToString(tableNumber)); // path parameter
                                                if (stateContract.GetType() != typeof(byte[]))
            {
            ...
            if (localVarStatusCode >= 400)
                throw new ApiException (localVarStatusCode, "Error calling SetTableState: " + localVarResponse.Content, localVarResponse.Content);
            else if (localVarStatusCode == 0)
                throw new ApiException (localVarStatusCode, "Error calling SetTableState: " + localVarResponse.ErrorMessage, localVarResponse.ErrorMessage);
        ...
        {
            // verify the required parameter 'restaurantId' is set
            if (restaurantId == null) throw new ApiException(400, "Missing required parameter 'restaurantId' when calling SetTableState");
            // verify the required parameter 'tableNumber' is set
            if (tableNumber == null) throw new ApiException(400, "Missing required parameter 'tableNumber' when calling SetTableState");
            // verify the required parameter 'stateContract' is set
            if (stateContract == null) throw new ApiException(400, "Missing required parameter 'stateContract' when calling SetTableState");
